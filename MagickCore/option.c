...
static const OptionInfo
  ...
  ColorspaceOptions[] =
  {
    ...
    { "Jab", JabColorspace, UndefinedOptionFlag, MagickFalse },
    { "JCH", JCHColorspace, UndefinedOptionFlag, MagickFalse },
    { "JCHab", JCHabColorspace, UndefinedOptionFlag, MagickFalse },
    { "JCHuv", JCHuvColorspace, UndefinedOptionFlag, MagickFalse },
