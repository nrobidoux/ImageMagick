...
#define ConvertJCHabToRGB  PrependMagickMethod(ConvertJCHabToRGB)
#define ConvertJCHuvToRGB  PrependMagickMethod(ConvertJCHuvToRGB)
...
#define ConvertRGBToJab  PrependMagickMethod(ConvertRGBToJab)
#define ConvertRGBToJCHab  PrependMagickMethod(ConvertRGBToJCHab)
#define ConvertRGBToJCHuv  PrependMagickMethod(ConvertRGBToJCHuv)
